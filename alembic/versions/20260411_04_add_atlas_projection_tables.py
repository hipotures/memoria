...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("connector_instance_id", sa.String(length=120), nullable=False, server_default=""),
        sa.Column("screen_category", sa.String(length=120), nullable=False, server_default=""),
        sa.Column("has_knowledge", sa.Boolean(), nullable=False, server_default=sa.text("0")),
